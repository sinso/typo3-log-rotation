...
namespace Sinso\LogRotation\Log\Writer;

use Sinso\LogRotation\Log\Writer\Enum\Interval;
...
class RotatingFileWriter extends FileWriter
{
    ...
    public function __construct(array $options = [])
    {
        ...
        if ($typo3Version->getMajorVersion() >= 13) {
            trigger_error('You\'re using the backported ' . self::class . ' class, but also TYPO3 13 or newer which has this feature natively. Please switch to TYPO3\CMS\Core\Log\Writer\RotatingFileWriter', E_USER_DEPRECATED);
        }
